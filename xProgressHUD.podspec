...
Pod::Spec.new do |s|
  s.name             = 'xProgressHUD'
  s.version          = '0.1.0'
  s.summary          = 'A short description of xProgressHUD.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kaibuleite/xProgressHUD'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kaibuleite' => '177955297@qq.com' }
  s.source           = { :git => 'https://github.com/kaibuleite/xProgressHUD.git', :tag => s.version.to_s }
